...
const TrafficDistribution = ({ cardSx, contentSx }: TrafficDistributionProps) => {
          ...
          <Grid
            ...
            <Box
              sx={{
                ...
                aspectRatio: "1",
                margin: "0 auto",
                "& > div": { margin: "0 auto", height: "100%", width: "100%" },
              }}
            >
              <Chart
                options={{ ...optionscolumnchart, chart: { ...optionscolumnchart.chart, height: "100%" } }}
